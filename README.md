...
- A LangChain (https://www.langchain.com) AI agent implementation calling a local model checker to temporal model check concurrent implementations expressed in a finite state machine description.
